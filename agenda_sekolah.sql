...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 13, 2025 at 03:05 AM
...
(6, 'X ANIMASI - A'),
(7, 'X ANIMASI - B'),
(8, 'X KIMIA INDUSTRI - A'),
(9, 'X KIMIA INDUSTRI - B'),
(10, 'X KIMIA INDUSTRI - C'),
(11, 'X TEKNIK PEMESINAN - A'),
(12, 'X TEKNIK PEMESINAN - B'),
(13, 'X MEKATRONIKA - A'),
(14, 'X MEKATRONIKA - B'),
(15, 'X MEKATRONIKA - C'),
(16, 'X MEKATRONIKA - D'),
...
(22, 'XI ANIMASI - A'),
(23, 'XI ANIMASI - B'),
(24, 'XI KIMIA INDUSTRI - A'),
(25, 'XI KIMIA INDUSTRI - B'),
(26, 'XI KIMIA INDUSTRI - C'),
(27, 'XI TEKNIK PEMESINAN-A'),
(28, 'XI TEKNIK PEMESINAN-B'),
(29, 'XI MEKATRONIKA - A'),
(30, 'XI MEKATRONIKA - B'),
(31, 'XI MEKATRONIKA - C'),
(32, 'XI MEKATRONIKA - D'),
...
(38, 'XII ANIMASI - A'),
(39, 'XII ANIMASI - B'),
(40, 'XII KIMIA INDUSTRI - A'),
(41, 'XII KIMIA INDUSTRI - B'),
(42, 'XII KIMIA INDUSTRI - C'),
(43, 'XII TEKNIK PEMESINAN-A'),
(44, 'XII TEKNIK PEMESINAN-B'),
(45, 'XII MEKATRONIKA - A'),
(46, 'XII MEKATRONIKA - B'),
(47, 'XII MEKATRONIKA - C'),
(48, 'XII MEKATRONIKA - D');
...
(2, 'X RPL A', 'XRPLA', 'XRPLA', 'siswa'),
(3, 'X RPL B', 'XRPLB', 'XRPLB', 'siswa'),
(4, 'X DKV - A', 'XDKVA', 'XDKVA', 'siswa'),
(5, 'X DKV - B', 'XDKVB', 'XDKVB', 'siswa'),
(6, 'X DKV - C', 'XDKVC', 'XDKVC', 'siswa'),
(7, 'X ANIMASI - A', 'XANIMASIA', 'XANIMASIA', 'siswa'),
(8, 'X ANIMASI - B', 'XANIMASIB', 'XANIMASIB', 'siswa'),
(9, 'X KIMIA INDUSTRI - A', 'XKIMIAINDUSTRIA', 'XKIMIAINDUSTRIA', 'siswa'),
(10, 'X KIMIA INDUSTRI - B', 'XKIMIAINDUSTRIB', 'XKIMIAINDUSTRIB', 'siswa'),
(11, 'X KIMIA INDUSTRI - C', 'XKIMIAINDUSTRIC', 'XKIMIAINDUSTRIC', 'siswa'),
(12, 'X TEKNIK PEMESINAN - A', 'XTEKNIKPEMESINANA', 'XTEKNIKPEMESINANA', 'siswa'),
(13, 'X TEKNIK PEMESINAN - B', 'XTEKNIKPEMESINANB', 'XTEKNIKPEMESINANB', 'siswa'),
(14, 'X MEKATRONIKA - A', 'XMEKATRONIKAA', 'XMEKATRONIKAA', 'siswa'),
(15, 'X MEKATRONIKA - B', 'XMEKATRONIKAB', 'XMEKATRONIKAB', 'siswa'),
(16, 'X MEKATRONIKA - C', 'XMEKATRONIKAC', 'XMEKATRONIKAC', 'siswa'),
(17, 'X MEKATRONIKA - D', 'XMEKATRONIKAD', 'XMEKATRONIKAD', 'siswa'),
(18, 'XI RPL A', 'XIRPLA', 'XIRPLA', 'siswa'),
(19, 'XI RPL B', 'XIRPLB', 'XIRPLB', 'siswa'),
(20, 'XI DKV - A', 'XIDKVA', 'XIDKVA', 'siswa'),
(21, 'XI DKV - B', 'XIDKVB', 'XIDKVB', 'siswa'),
(22, 'XI DKV - C', 'XIDKVC', 'XIDKVC', 'siswa'),
(23, 'XI ANIMASI - A', 'XIANIMASIA', 'XIANIMASIA', 'siswa'),
(24, 'XI ANIMASI - B', 'XIANIMASIB', 'XIANIMASIB', 'siswa'),
(25, 'XI KIMIA INDUSTRI - A', 'XIKIMIAINDUSTRIA', 'XIKIMIAINDUSTRIA', 'siswa'),
(26, 'XI KIMIA INDUSTRI - B', 'XIKIMIAINDUSTRIB', 'XIKIMIAINDUSTRIB', 'siswa'),
(27, 'XI KIMIA INDUSTRI - C', 'XIKIMIAINDUSTRIC', 'XIKIMIAINDUSTRIC', 'siswa'),
(28, 'XI TEKNIK PEMESINAN-A', 'XITEKNIKPEMESINANA', 'XITEKNIKPEMESINANA', 'siswa'),
(29, 'XI TEKNIK PEMESINAN-B', 'XITEKNIKPEMESINANB', 'XITEKNIKPEMESINANB', 'siswa'),
(30, 'XI MEKATRONIKA - A', 'XIMEKATRONIKAA', 'XIMEKATRONIKAA', 'siswa'),
(31, 'XI MEKATRONIKA - B', 'XIMEKATRONIKAB', 'XIMEKATRONIKAB', 'siswa'),
(32, 'XI MEKATRONIKA - C', 'XIMEKATRONIKAC', 'XIMEKATRONIKAC', 'siswa'),
(33, 'XI MEKATRONIKA - D', 'XIMEKATRONIKAD', 'XIMEKATRONIKAD', 'siswa'),
(34, 'XII RPL A', 'XIIRPLA', 'XIIRPLA', 'siswa'),
(35, 'XII RPL B', 'XIIRPLB', 'XIIRPLB', 'siswa'),
(36, 'XII DKV - A', 'XIIDKVA', 'XIIDKVA', 'siswa'),
(37, 'XII DKV - B', 'XIIDKVB', 'XIIDKVB', 'siswa'),
(38, 'XII DKV - C', 'XIIDKVC', 'XIIDKVC', 'siswa'),
(39, 'XII ANIMASI - A', 'XIIANIMASIA', 'XIIANIMASIA', 'siswa'),
(40, 'XII ANIMASI - B', 'XIIANIMASIB', 'XIIANIMASIB', 'siswa'),
(41, 'XII KIMIA INDUSTRI - A', 'XIIKIMIAINDUSTRIA', 'XIIKIMIAINDUSTRIA', 'siswa'),
(42, 'XII KIMIA INDUSTRI - B', 'XIIKIMIAINDUSTRIB', 'XIIKIMIAINDUSTRIB', 'siswa'),
(43, 'XII KIMIA INDUSTRI - C', 'XIIKIMIAINDUSTRIC', 'XIIKIMIAINDUSTRIC', 'siswa'),
(44, 'XII TEKNIK PEMESINAN-A', 'XIITEKNIKPEMESINANA', 'XIITEKNIKPEMESINANA', 'siswa'),
(45, 'XII TEKNIK PEMESINAN-B', 'XIITEKNIKPEMESINANB', 'XIITEKNIKPEMESINANB', 'siswa'),
(46, 'XII MEKATRONIKA - A', 'XIIMEKATRONIKAA', 'XIIMEKATRONIKAA', 'siswa'),
(47, 'XII MEKATRONIKA - B', 'XIIMEKATRONIKAB', 'XIIMEKATRONIKAB', 'siswa'),
(48, 'XII MEKATRONIKA - C', 'XIIMEKATRONIKAC', 'XIIMEKATRONIKAC', 'siswa'),
(49, 'XII MEKATRONIKA - D', 'XIIMEKATRONIKAD', 'XIIMEKATRONIKAD', 'siswa');
...
--
ALTER TABLE `mapel`
  MODIFY `id_mapel` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=113;
